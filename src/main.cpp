...
unsigned int nStakeMinAge = 60 * 60 * 24 * .5;	// minimum age for coin age: 12h
unsigned int nStakeMaxAge = 60 * 60 * 24 * 56;	// stake age of full weight: 56d
...
bool CBlock::AcceptBlock()
{
    ...
    // Check proof of work has reached block 30,000
